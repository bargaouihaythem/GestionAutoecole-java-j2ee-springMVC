				...
				<div class="row clearfix">
					...
					<div class="table">
						<table>
							...
							<tbody>
								<c:forEach var="u" items="${listPay}">
									<tr>
										<td>${u.condidatid.userid.nom}&nbsp;${u.condidatid.userid.prenom}</td>

										<td>${u.moniteurid.userid.nom}&nbsp;${u.moniteurid.userid.prenom}</td>

										<td>${u.total_conduit}</td>
										<td>${u.nbseance}</td>
										<td>${u.montant_total}</td>
