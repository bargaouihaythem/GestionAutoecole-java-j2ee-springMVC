	...
	<div id="home">
		...
		<div id="layout" class="full">
					...
					<div class="row clearfix">
						...
						<nav class="main">
							...
							<li class="menu-item"><a href="#">Gestion véhicule</a>
								...
								<li class="menu-item"><a href="#">gestion
										séance</a>
									<ul class="sub-menu">
										<li class="menu-item"><a href="addseance">Ajouter Seance</a></li>
										<li class="menu-item"><a href="listseance">Editer Séance</a></li>
			...
			<div class="breadcrumb-place ">
				<div class="row clearfix">
					<h1 class="page-title">List des seances</h1>
				</div>
				<!-- row -->
			</div>
			<!-- breadcrumb -->
				...
				<div class="row clearfix">
					...
					<div class="table">
						<table>
							<thead>
								<tr>
									<th scope="col">nom prénon Candidat</th>
									<th scope="col">tel candidat</th>
									<th scope="col">nom prénon moniteur</th>
							...
							<tbody>
								<c:forEach var="u" items="${seanceList}">
									<tr>
										<td>${u.condidat.userid.nom}&nbsp;${u.condidat.userid.prenom}</td>
										<td>${u.condidat.userid.nrotel}</td>
										<td>${u.moniteur.userid.nom}&nbsp;${u.moniteur.userid.prenom}</td>
										<td>${u.vehicule.marque}&nbsp;${u.vehicule.couleur}</td>
										<td>${u.date_seance}</td>
										<td>${u.heure_deb}</td>
										<td>${u.heure_fin}</td>
										<td><a class="btn btn-danger"
											href="deletSeance?id=${u.id}"> <i
												class="icon-trash icon-white"></i>
										</a> <a class="btn btn-danger" href="updateSeanceview?id=${u.id}">
