	...
	<div id="home">
		...
		<div id="layout" class="full">
			...
			<div class="breadcrumb-place ">
				<div class="row clearfix">
					<h1 class="page-title">List des inscrits</h1>
				</div>
				<!-- row -->
			</div>
			<!-- breadcrumb -->
						...
						<table>
							...
							<tbody>
								<c:forEach var="u" items="${userList}">
									<tr>
										<td>${u.userid.nom}${u.userid.prenom}</td>
										<td>${u.userid.nrotel}</td>
										<td>${u.userid.cin}</td>
										<td>${u.userid.role.rolename}</td>
										<td><a class="btn btn-danger"
											href="deletMoniteur?id=${u.id}"> <i
												class="icon-trash icon-white"></i>
										</a> <a class="btn btn-danger" href="updateMoniteur?id=${u.id}">
